 ...
 */
locale: string, correctness: CorrectnessView, 
/**
 * Canonical answer shown to moderators when localized correctness differs.
 */
canonical_locale: string | null, canonical_correctness: CorrectnessView | null, explanation: string | null, };

export type ChoiceView = { id: string, text: string, media: MediaView | null, };

export type ClientMessage = { "kind": "Join", name: string, locale: string, } | { "kind": "Reconnect", token: string, locale: string, } | { "kind": "Authed", token: string, cmd: Command, };
